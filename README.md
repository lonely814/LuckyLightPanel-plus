...
| 对比项 | 原版 | 二创版 |
|--------|------|--------|
| 主题数量 | 浅色 / 深色 | 浅色、深色 + **包豪斯、复古终端、光牌点阵、调光控制台、运维小票** 共 7 个 |
| 背景表现 | 通用渐变 | 每个主题带**独立动态背景组件**（几何图形 / CRT 扫描线 / 点阵 / 调光台 / 打印纸） |
| 维护方式 | 主题散落 5 处维护 | 新增 `src/themes/registry.ts` **主题注册表**，元数据单一来源 |
